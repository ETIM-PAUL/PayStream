...
const employeeContract = new ethers.Contract(EMPLOYEE_CONTRACT_ADDRESS, EMPLOYEE_CONTRACT_ABI, provider);
export const vincentPolicy = createVincentPolicy({
    packageName: "@agentic-ai/vincent-double_signature_policy",
    toolParamsSchema,
    userParamsSchema,
    commitParamsSchema,
